...
type ListenerForCreate struct {
	...
	SessionDurationTime int32                  `json:"session_duration_time"`
...
// GetSessionDurationTime returns the SessionDurationTime field value
func (o *ListenerForCreate) GetSessionDurationTime() int32 {
	...
	return o.SessionDurationTime
}

// GetSessionDurationTimeOk returns a tuple with the SessionDurationTime field value
// and a boolean to check if the value has been set.
func (o *ListenerForCreate) GetSessionDurationTimeOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.SessionDurationTime, true
}

// SetSessionDurationTime sets field value
func (o *ListenerForCreate) SetSessionDurationTime(v int32) {
	o.SessionDurationTime = v
}
...
func (o ListenerForCreate) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["session_duration_time"] = o.SessionDurationTime
